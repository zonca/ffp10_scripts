...
srun -n $ntasktot  --ntasks-per-node=6 --ntasks-per-socket=3 --cpus-per-task=4 --export=ALL $python -s $bin/toast_planck_ringsets.py @temp/ringsets_dx12_{tag}.par
